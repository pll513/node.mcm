...
V = 10*[1* (rand(1,N) - 0.5);1 * (rand(1,N) - 0.5);1 * (rand(1,N) - 0.5);1 * (rand(1,N) - 0.5)];
pBest1 = X;
pBest2 = X;
...
for j = 1:500
    for i = 1:N
        ...
        if Fitness1(i)<dA(pBest1(1,i),pBest1(2,i),pBest1(3,i),pBest1(4,i))/dB0
            pBest1(:,i) = X(:,i);
        end
        if Fitness2(i)<pA(pBest2(1,i),pBest2(2,i),pBest2(3,i),pBest2(4,i))/pB0
            pBest2(:,i) = X(:,i);
        end
    end
